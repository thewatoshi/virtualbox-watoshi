...
# define RTAcpiChecksumGenerate                         RT_MANGLER(RTAcpiChecksumGenerate)
# define RTAcpiResourceAdd32BitFixedMemoryRange         RT_MANGLER(RTAcpiResourceAdd32BitFixedMemoryRange)
# define RTAcpiResourceAddDma                           RT_MANGLER(RTAcpiResourceAddDma)
# define RTAcpiResourceAddDWordMemoryRange              RT_MANGLER(RTAcpiResourceAddDWordMemoryRange)
# define RTAcpiResourceAddDWordMemoryRangeEx            RT_MANGLER(RTAcpiResourceAddDWordMemoryRangeEx)
# define RTAcpiResourceAddExtendedInterrupt             RT_MANGLER(RTAcpiResourceAddExtendedInterrupt)
# define RTAcpiResourceAddGpioInt                       RT_MANGLER(RTAcpiResourceAddGpioInt)
# define RTAcpiResourceAddIo                            RT_MANGLER(RTAcpiResourceAddIo)
# define RTAcpiResourceAddIrq                           RT_MANGLER(RTAcpiResourceAddIrq)
# define RTAcpiResourceAddQWordIoRange                  RT_MANGLER(RTAcpiResourceAddQWordIoRange)
# define RTAcpiResourceAddQWordMemoryRange              RT_MANGLER(RTAcpiResourceAddQWordMemoryRange)
# define RTAcpiResourceAddQWordMemoryRangeEx            RT_MANGLER(RTAcpiResourceAddQWordMemoryRangeEx)
# define RTAcpiResourceAddWordBusNumber                 RT_MANGLER(RTAcpiResourceAddWordBusNumber)
# define RTAcpiResourceAddWordBusNumberEx               RT_MANGLER(RTAcpiResourceAddWordBusNumberEx)
# define RTAcpiResourceAddWordIoRangeEx                 RT_MANGLER(RTAcpiResourceAddWordIoRangeEx)
...
# define RTAcpiTblArgOpAppend                           RT_MANGLER(RTAcpiTblArgOpAppend)
# define RTAcpiTblBinaryOpAppend                        RT_MANGLER(RTAcpiTblBinaryOpAppend)
# define RTAcpiTblBufferAppend                          RT_MANGLER(RTAcpiTblBufferAppend)
# define RTAcpiTblBufferAppendRawData                   RT_MANGLER(RTAcpiTblBufferAppendRawData)
# define RTAcpiTblBufferFinalize                        RT_MANGLER(RTAcpiTblBufferFinalize)
# define RTAcpiTblBufferStart                           RT_MANGLER(RTAcpiTblBufferStart)
# define RTAcpiTblConvertFromVfsIoStrm                  RT_MANGLER(RTAcpiTblConvertFromVfsIoStrm)
# define RTAcpiTblCreate                                RT_MANGLER(RTAcpiTblCreate)
# define RTAcpiTblCreateFromVfsIoStrm                   RT_MANGLER(RTAcpiTblCreateFromVfsIoStrm)
# define RTAcpiTblCreateFromFile                        RT_MANGLER(RTAcpiTblCreateFromFile)
# define RTAcpiTblDestroy                               RT_MANGLER(RTAcpiTblDestroy)
# define RTAcpiTblDeviceFinalize                        RT_MANGLER(RTAcpiTblDeviceFinalize)
...
# define RTAcpiTblEisaIdAppend                          RT_MANGLER(RTAcpiTblEisaIdAppend)
...
# define RTAcpiTblHdrChecksumGenerate                   RT_MANGLER(RTAcpiTblHdrChecksumGenerate)
# define RTAcpiTblIfFinalize                            RT_MANGLER(RTAcpiTblIfFinalize)
# define RTAcpiTblIfStart                               RT_MANGLER(RTAcpiTblIfStart)
# define RTAcpiTblIndexFieldAppend                      RT_MANGLER(RTAcpiTblIndexFieldAppend)
# define RTAcpiTblIntegerAppend                         RT_MANGLER(RTAcpiTblIntegerAppend)
# define RTAcpiTblLocalOpAppend                         RT_MANGLER(RTAcpiTblLocalOpAppend)
# define RTAcpiTblMethodStart                           RT_MANGLER(RTAcpiTblMethodStart)
# define RTAcpiTblMethodStartF                          RT_MANGLER(RTAcpiTblMethodStartF)
# define RTAcpiTblMethodStartV                          RT_MANGLER(RTAcpiTblMethodStartV)
# define RTAcpiTblMethodFinalize                        RT_MANGLER(RTAcpiTblMethodFinalize)
# define RTAcpiTblNameAppend                            RT_MANGLER(RTAcpiTblNameAppend)
# define RTAcpiTblNameStringAppend                      RT_MANGLER(RTAcpiTblNameStringAppend)
# define RTAcpiTblNameStringAppendF                     RT_MANGLER(RTAcpiTblNameStringAppendF)
# define RTAcpiTblNameStringAppendV                     RT_MANGLER(RTAcpiTblNameStringAppendV)
# define RTAcpiTblNullNameAppend                        RT_MANGLER(RTAcpiTblNullNameAppend)
# define RTAcpiTblOpRegionAppend                        RT_MANGLER(RTAcpiTblOpRegionAppend)
# define RTAcpiTblOpRegionAppendEx                      RT_MANGLER(RTAcpiTblOpRegionAppendEx)
# define RTAcpiTblPackageStart                          RT_MANGLER(RTAcpiTblPackageStart)
# define RTAcpiTblPackageFinalize                       RT_MANGLER(RTAcpiTblPackageFinalize)
# define RTAcpiTblProcessorStart                        RT_MANGLER(RTAcpiTblProcessorStart)
# define RTAcpiTblProcessorStartF                       RT_MANGLER(RTAcpiTblProcessorStartF)
# define RTAcpiTblProcessorStartV                       RT_MANGLER(RTAcpiTblProcessorStartV)
# define RTAcpiTblProcessorFinalize                     RT_MANGLER(RTAcpiTblProcessorFinalize)
# define RTAcpiTblResourceAppend                        RT_MANGLER(RTAcpiTblResourceAppend)
# define RTAcpiTblScopeFinalize                         RT_MANGLER(RTAcpiTblScopeFinalize)
...
# define RTAcpiTblStringAppendF                         RT_MANGLER(RTAcpiTblStringAppendF)
# define RTAcpiTblStringAppendV                         RT_MANGLER(RTAcpiTblStringAppendV)
...
# define RTAcpiTblWhileFinalize                         RT_MANGLER(RTAcpiTblWhileFinalize)
# define RTAcpiTblWhileStart                            RT_MANGLER(RTAcpiTblWhileStart)
...
# define RTFsIsoMakerSetPathInfo                        RT_MANGLER(RTFsIsoMakerSetPathInfo)
# define RTFsIsoMakerSetPathInfoByObj                   RT_MANGLER(RTFsIsoMakerSetPathInfoByObj)
# define RTFsIsoMakerSetPathInfoByParentObj             RT_MANGLER(RTFsIsoMakerSetPathInfoByParentObj)
...
# define RTJsonValueGetObjectMemberCount                RT_MANGLER(RTJsonValueGetObjectMemberCount)
...
# define RTJsonValueQueryObjectMemberCount              RT_MANGLER(RTJsonValueQueryObjectMemberCount)
...
# define RTProcQueryExecutablePath                      RT_MANGLER(RTProcQueryExecutablePath)
# define RTProcQueryExecutablePathA                     RT_MANGLER(RTProcQueryExecutablePathA)
...
# define RTSystemGetNativeArch                          RT_MANGLER(RTSystemGetNativeArch)
...
# define RTTimeNanoTSSyncInvarNoDelta                   RT_MANGLER(RTTimeNanoTSSyncInvarNoDelta)
# define RTTimeNanoTSSyncInvarWithDelta                 RT_MANGLER(RTTimeNanoTSSyncInvarWithDelta)
# define RTTimeNanoTSSyncInvarWithDeltaUseTpIdRRo       RT_MANGLER(RTTimeNanoTSSyncInvarWithDeltaUseTpIdRRo)
# define RTTimeNanoTSAsync                              RT_MANGLER(RTTimeNanoTSAsync)
# define RTTimeNanoTSAsyncUseTpIdRRo                    RT_MANGLER(RTTimeNanoTSAsyncUseTpIdRRo)
