/* $Id: UICloudProfileManager.cpp 112751 2026-01-29 16:30:52Z sergey.dubov@oracle.com $ */
/** @file
...
void UICloudProfileManagerWidget::prepare()
{
    ...
    uiCommon().setHelpKeyword(this, "tk_using-cloud-profile-manager" /* help keyword */);
