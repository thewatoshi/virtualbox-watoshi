# -*- coding: utf-8 -*-
# $Id: vbox.py 112674 2026-01-23 14:44:38Z ksenia.s.stepanova@oracle.com $
...
class TestDriver(base.TestDriver):                                              # pylint: disable=too-many-instance-attributes
    ...
    def _provideProxy(self, dEnv=os.environ, sProxy):
        """
    ...
    def parseOption(self, asArgs, iArg): # pylint: disable=too-many-branches,too-many-statements
        if asArgs[iArg] == '--vbox-session-type':
            ...
            self.sProxyUrl = 'www-proxy-ams.nl.oracle.com:80/';
