/* $Id: tstVBoxInstHlpCheckTargetDir.cpp 110249 2025-07-16 12:51:34Z klaus.espenlaub@oracle.com $ */
/** @file
...
} g_aTests[] =
{
    ...
    { "$SystemDrive$\\Temp", VERR_INVALID_NAME },
...
UINT VBoxMsiSetProp(MSIHANDLE hMsi, const WCHAR *pwszName, const WCHAR *pwszValue)
{
    ...
    if (!RTUtf16NCmpUtf8(pwszName, "VBox_Target_Dir_Is_Valid",  RTPATH_MAX, RT_ELEMENTS("VBox_Target_Dir_Is_Valid")))
    {
        ...
        RTTESTI_CHECK_MSG(rc == g_aTests[g_idxTest].rc, ("Tested %#d failed: Expected %Rrc, got %Rrc\n",
